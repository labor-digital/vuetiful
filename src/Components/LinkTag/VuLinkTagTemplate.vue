...
import type {TLinkType} from './types';
import type VuLinkTagAbstract from './VuLinkTagAbstract.vue';

let canUseVueRouterLink: boolean | null = null;
let canUseNuxtLink: boolean | null = null;
