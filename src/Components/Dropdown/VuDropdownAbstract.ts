...
@Component({
    ...
    {
        return {
            dropdownApi: new VuDropdownApi(this as VuDropdownAbstract)
        };
    },
    mixins: [ElementIdAwareMixin, ProxyAwareMixin]
})
export default class VuDropdownAbstract extends Mixins(ProxyAwareMixin, ElementIdAwareMixin)
{
    ...
    get isOpen(): boolean
    {
        return !isNull(this.value) ? this.value : this.fallbackValue;
    }
